...
2026-09-23 当前远端状态：最新主线提交 `7a88e68` 的 GitHub CI `35795149009` 与 CD `35795413526` 均成功。线上 `build-info.json` 已核对为版本 `0.29.0`、提交 `7a88e68e66044e1ddfceee16dbde4b824b593739`、站点 SHA-256 `4a03500873c333d85f2d9b3a4a6d5cee19122c218135270aee968ca77d5f2dff`。该部署证明主线门禁和部署链路通过，但不会将原先绑定本地候选哈希的浏览器报告自动改签；npm 注册表仍未发布，不能据此宣布 v1.0.0。
