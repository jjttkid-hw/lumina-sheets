...
2026-09-23 当前远端状态：最新主线提交 `0d70ef9` 的 GitHub CI `35793770431` 与 CD `35794049144` 均成功。线上 `build-info.json` 已核对为版本 `0.29.0`、提交 `0d70ef97706e35936d30845839302ec72c673025`、站点 SHA-256 `592f0c1342176b6cd098cd322ca15a741a43a393f9d05bd8ad35d9959525084f`。该部署证明主线门禁和部署链路通过，但不会将原先绑定本地候选哈希的浏览器报告自动改签；npm 注册表仍未发布，不能据此宣布 v1.0.0。
