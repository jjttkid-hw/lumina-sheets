...
2026-09-23 当前远端状态：最新主线提交 `bd4ca99` 的 GitHub CI `35794796200` 与 CD `35795054145` 均成功。线上 `build-info.json` 已核对为版本 `0.29.0`、提交 `bd4ca99c80a56b9d82bbf8bc5bee24ca6fbf067c`、站点 SHA-256 `a69529d3b0d0a5864c8117b1f74eeacf766c9d475075d9aec5e83a9fd3330e3e`。该部署证明主线门禁和部署链路通过，但不会将原先绑定本地候选哈希的浏览器报告自动改签；npm 注册表仍未发布，不能据此宣布 v1.0.0。
