当前候选以 [r20](acceptance/browser-candidate-2026-09-24-r20/README.md) 为准。缓存最近访问页修正已通过 2,347 项测试及 25 份浏览器报告；版本保持 0.29.0。npm 认证仍返回 E401，首次发布及外部平台验收尚未完成。下文为历史记录。
