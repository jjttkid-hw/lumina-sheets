...
2026-09-23 当前候选更新：提交 `03874c9` 更新了 v1 验收账本，并已由 GitHub CI `35781888414` 与 CD `35782263452` 验证部署；Pages `build-info.json` 已绑定该提交，线上版本为 `0.29.0`，站点摘要为 `148b04ff5eab722d208e3724285ebfee14397eb3e18ffaa945a924e44e5ec9f3`。本地与远端门禁均通过；npm 注册表仍未发布，不能据此宣布 v1.0.0。
