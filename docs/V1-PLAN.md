...
2026-09-23 当前远端状态：最新主线提交 `316c856` 的 GitHub CI `35797403060` 与 CD `35797664606` 均成功。线上 `build-info.json` 已核对为版本 `0.29.0`、提交 `316c856a821125593ec02afa5edd0ca167147dc8`、站点 SHA-256 `9f114913227673af2c24a1a8c8716c6a620c09d5b62b0739dcd32cfe51727dbc`。该部署证明主线门禁和部署链路通过，但不会将原先绑定本地候选哈希的浏览器报告自动改签；npm 注册表仍未发布，不能据此宣布 v1.0.0。
