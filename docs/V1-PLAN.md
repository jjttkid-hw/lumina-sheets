...
2026-09-23 当前候选更新：提交 `db42633` 将验收账本绑定到实际部署候选，并已由 GitHub CI `35782388493` 与 CD `35782732045` 验证；Pages `build-info.json` 已绑定该提交，线上版本为 `0.29.0`，站点摘要为 `7752e236825177d2be4215e8f069593246ee1cc6affb495d03005b9f16b1b0c9`。本地与远端门禁均通过；npm 注册表仍未发布，不能据此宣布 v1.0.0。
