...
| --- | --- | --- | --- |
| Canvas 工作表 | 稀疏静态表、冻结、隐藏、筛选、合并、键盘编辑、公式栏、撤销/重做；r9 候选已在 Chromium/Firefox/WebKit 自动化通过，Safari 已完成线上定向复验 | 再完成 Safari 核心矩阵、移动实体触控和辅助技术验收，并绑定最终候选制品 | 百万实存格结构编辑恒定帧时间 |
